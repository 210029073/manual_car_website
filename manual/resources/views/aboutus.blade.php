...
<div class="AboutUs">
      ...
      <div class="boxer">
        <h1>Introduction</h1>
        <h2>Manual is a digital business which is built to help customers to be able to afford well functioning cars for cheaper.</h2></div>
 </div>  
</div>
